...
publish:
	git tag -s v0.1.0 -m "fncmp v0.1.1" && \
	GOPROXY=proxy.golang.org go list -m github.com/kitkitchen/fncmp@v0.1.1

lookup:
	curl https://sum.golang.org/lookup/github.com/kitkitchen/fncmp@v0.1.1