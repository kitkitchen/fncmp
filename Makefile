...
publish:
	git tag -s v0.3.302 -m "fncmp v0.3.302" && \
	git push --tags && \
	GOPROXY=proxy.golang.org go list -m github.com/kitkitchen/fncmp@v0.3.302 && \
	curl https://sum.golang.org/lookup/github.com/kitkitchen/fncmp@v0.3.302