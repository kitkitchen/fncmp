...
publish:
	git tag -s v0.3.1 -m "fncmp v0.3.1" && \
	git push --tags && \
	GOPROXY=proxy.golang.org go list -m github.com/kitkitchen/fncmp@v0.3.1

lookup:
	curl https://sum.golang.org/lookup/github.com/kitkitchen/fncmp@v0.3.1